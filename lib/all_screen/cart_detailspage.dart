                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          // dekhte hobe
                                          controller.cartItemsList[index].discount != null
                                              ? Align(
                                                  alignment: Alignment.centerLeft,
                                                  child: Container(
                                                    //color: Colors.green,
                                            ...
                                            onTap: () {
                                              controller.addToCart(
                                                OrderItemModel(
                                                  productId: bestProducts[index].id,
                                                  price:
                                                      int.tryParse(bestProducts[index].baseDiscountedPrice!.toString().replaceAll('৳', '')),
                                                  productThumbnailImage: bestProducts[index].thumbnailImage,
                                                  productName: bestProducts[index].name,
                                                  quantity: 1,
                                                  userId: box.read(userID),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: Center(
                          child: Text(
                            UserPreference.getBool(UserPreference.isLoggedIn)! ? "Payment method & Address" : "Login to continue",
                            style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w800),
                          ),
                        ),
                        width: 260,
