...
class _MyHomePageState extends State<SignUpPage> {
  ...
  Future userSignUp(name, emailOrPhone, password) async {
    var jsonBody = (<String, dynamic>{"name": name, "email_or_phone": emailOrPhone, "password": password, "password_confirmation": password, "register_by": 'test', 'cwallet': '1222222'});

    debugPrint(jsonBody.toString());

    var res = await http.post(Uri.parse(userSignupAPI), headers: <String, String>{'Accept': 'application/json'}, body: jsonBody);
                ...
                child: ButtonWidget(
                  ...
                  callback: () {
                    ...
                    if (formKey.currentState == null || formKey.currentState!.validate()){
                      userSignUp(userNameController.text, userEmailOrPhoneController.text, userPasswordController.text).then((value) => print(value));
