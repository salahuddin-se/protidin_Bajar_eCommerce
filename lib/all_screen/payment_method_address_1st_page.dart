...
class PaymentAddress1stPage extends StatefulWidget {
  ...
  PaymentAddress1stPage({required this.grandTotal, required this.ownerId});
...
import 'package:customer_ui/all_screen/payment_successfull.dart';
import 'package:customer_ui/components/apis.dart';
import 'package:customer_ui/components/styles.dart';
import 'package:customer_ui/components/utils.dart';
import 'package:customer_ui/dataModel/payment_method.dart';
...
class PaymentAddress1stPage extends StatefulWidget {
  const PaymentAddress1stPage({Key? key}) : super(key: key);
...
class _PaymentAddress1stPageState extends State<PaymentAddress1stPage> {
  ...
  Future<void> getUserAddress(userID) async {
    ...
    if (res.statusCode == 200 || res.statusCode == 201) {
      ...
      userPostalCode = userAddressData[0].postalCode;
      userPhone = userAddressData[0].phone;
      log("Area ${userAddressData[0].address} city ${userAddressData[0].city}  Country ${userAddressData[0].country}");
  ...
  Future<void> getPaymentTypes() async {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      var userAddressModel = PaymentTypeResponse.fromJson(dataMap);
    }
  }
  ...
  /*
    @override
  void setState(VoidCallback getUserAddress) {
    // TODO: implement setState
    super.setState(getUserAddress);
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      /*bottomSheet(
                          context: context, userId: userId, address: 'Kolabagan,Dhanmondi', country: 'Bangladesh', city: 'Dhaka', postalCode: '1100', phone: '01812009900',callBack: (){
