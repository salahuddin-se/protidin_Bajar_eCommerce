...
class AppConfig {
  static String copyright_text =
      "@ SYSABLE " + this_year; //this shows in the splash screen
  static String app_name = "Protidin"; //this shows in the splash screen
  static String purchase_code =
      "e61f6cbb-bf4f-4df0-bfc7-8b2632b513db"; //enter your purchase code for the app from codecanyon
  ...
  static const DOMAIN_PATH =
      "test.protidin.com.bd"; // directly inside the public folder
