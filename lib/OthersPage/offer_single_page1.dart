...
import 'package:customer_ui/OthersPage/productSinglePage1.dart';
...
class OfferSinglePage1 extends StatefulWidget {
  const OfferSinglePage1({Key? key}) : super(key: key);

  @override
  _OfferSinglePage1State createState() => _OfferSinglePage1State();
}

class _OfferSinglePage1State extends State<OfferSinglePage1> {
          ...
          children: [
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          height: 28,
                          //width: 200,
                          child: Center(child: Text("Offer",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500,color: Colors.black),)),
                        ),
                      ),
            ...
            Align(
                ...
                child: Padding(
                  ...
                  child: const Text("Enjoy up to 80% off on the following items:",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500,color: Colors.grey),),
                )),
